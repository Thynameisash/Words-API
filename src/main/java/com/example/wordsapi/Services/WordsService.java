...
public class WordsService {
    ...
    private static final ArrayList<String> words = new ArrayList<>(Arrays.asList(
            ...
            "Shrug", "Articulation", "Circulation", "Pellucid", "Indoctrination", "Gratuitous", "Egregious",
            "Circumlocution", "Equivocate", "Curmudgeon", "Surreptitious", "Puissant", "Solicitous", "Lamentable",
            "Condemned",
            "Placid", "Momentous", "Chipmunk", "Gratitude", "Pollination", "Armageddon", "Intoxication",
            "Circumference", "Croissant", "Solitude", "Chris Bumstead", "Equilibrium", "Amalgamation", "Generation",
            ...
            "retreat", "clay", "tip", "mention", "range", "trial", "wall", "authorise", "moving", "pollution",
            "cutting", "Creatine",
